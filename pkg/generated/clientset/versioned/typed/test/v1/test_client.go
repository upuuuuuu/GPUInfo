...
import (
	...
	"github.com/upuuuuuu/gpuinfo/pkg/generated/clientset/versioned/scheme"
	"net/http"
...
// TestV1Client is used to interact with features provided by the test.zxl.com group.
type TestV1Client struct {
	restClient rest.Interface
}

func (c *TestV1Client) Gpus(namespace string) GpuInterface {
